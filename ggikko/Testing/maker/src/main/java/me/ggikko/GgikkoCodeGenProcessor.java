...
//            ggikko.me.bottomsheet.BasicBottomSheetDialogFragment
            ...
            ClassName className1 = ClassName.get("ggikko.me.testing", className);

            ClassName bottomSheetName = ClassName.get("ggikko.me.bottomsheet", "BasicBottomSheetDialogFragment");

            MethodSpec targetMethod = MethodSpec.methodBuilder(className + "_BottomSheet")
                    .addParameter(className1, "target")
